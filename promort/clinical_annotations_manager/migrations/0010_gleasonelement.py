    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('focus_region_annotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gleason_elements', to='clinical_annotations_manager.FocusRegionAnnotation')),
            ],
        ),
    ]
