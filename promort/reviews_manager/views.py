...
class ReviewsDetail(APIView):
    ...
    def _find_by_case(self, case_id):
        try:
    ...
    def get(self, request, case, format=None):
        reviews = self._find_by_case(case)
...
class ReviewDetail(APIView):
    ...
    def _find_by_case_and_type(self, case_id, review_type):
        try:
    ...
    def get(self, request, case, review_type, format=None):
        review = self._find_by_case_and_type(case, review_type.upper())
